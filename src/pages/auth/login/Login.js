...
import bg_image from "../../../img-assets/auth__bg.png";
...
import LoginForm from "../register/form/LoginForm";
          ...
          <FlexItem flex={3}>
            <BackgorundWrapper>
              <BackgroundContent>
                ...
                <MiniText>Dont have an account?</MiniText>
                <ButtonAlternative
                  onClick={() => props.history.push("/register")}
                >
                  <span>Sign up</span> <AuthIcon />
                </ButtonAlternative>
              </BackgroundContent>
            </BackgorundWrapper>
          </FlexItem>
